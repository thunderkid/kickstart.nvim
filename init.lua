...
print("ThunderConfiguration 0.1 reloaded at: " .. os.date("%Y-%m-%d %H:%M:%S"))
-- /thunderstuff
...
vim.keymap.set('n', '<leader>sa', function() require('telescope.builtin').find_files( { hidden = true }) end, { desc = '[S]earch [A]ll (with hiddeny)' })
